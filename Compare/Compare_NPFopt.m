...
for i=1:N
    ...
    % else
    %     fprintf(fid_output_failed_MF0,['%3d&%9s&%4d&%4d&' ...
    %         '%4d/%4d&' ...
    %         '%4d/%4d/%4d&', ...
    %         '%4d/%4d/%4d&', ...
    %         '%4d/%4d/%4d&', ...
    ...
    %        i,Data_Lancelot_flag{i,3},Data_Lancelot(i,1:2),Data_Lancelot(i,3:4),Data_NPFopt{1}(i,[5,6,4]),Data_NPFopt{2}(i,[5,6,4]),Data_NPFopt{3}(i,[5,6,4]),Data_NPFopt{4}(i,[5,6,4]));
    % else
    %     fprintf(fid_output_failed_MF6,['%3d&%9s&%4d&%4d&' ...
    %         '%4d/%4d&' ...
    %         '%4d/%4d/%4d&', ...
    %         '%4d/%4d/%4d&', ...
    %         '%4d/%4d/%4d&', ...
...
% fclose(fid_output_successful_MF0);
% fclose(fid_output_failed_MF0);
% fclose(fid_output_successful_MF6);
